/**
 * Nothing important to review here. It's related to payload security and prevent any XSS attacks.
 */
...
const xss = (): RequestHandler => (req: Request, _res: Response, next: NextFunction): void => {
